...
const UserProfile = () => {
  ...
  return (
    <div className="user-profile">
      ...
      <div className="tabs">
        <button className={`tab-button ${activeTab === 'overview' ? 'active' : ''}`} onClick={() => handleTabClick('overview')}>Overview</button>
        <button className={`tab-button ${activeTab === 'favorites' ? 'active' : ''}`} onClick={() => handleTabClick('favorites')}>Favorites</button>
      ...
      <div className="content-section">
        {activeTab === 'overview' && (
          <>
            <h2>About Me</h2>
            <p>This is a short bio about the user. Include information about their background, interests, or any other personal details.</p>
